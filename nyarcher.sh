#!/bin/sh
RELEASE_LINK="https://github.com/NyarchLinux/NyarchLinux/releases/download/25.04.2/"
TAG_PATH="https://raw.githubusercontent.com/NyarchLinux/NyarchLinux/refs/tags/25.04.2/Gnome/"
